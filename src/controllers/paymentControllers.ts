...
export const handleNewCoupon = TryCatch(async (req: Request, res: Response, next: NextFunction) => {
...
export const handleApplyCoupon = TryCatch(async (req: Request, res: Response, next: NextFunction) => {
...
export const handleAllCoupons = TryCatch(async (req: Request, res: Response, next: NextFunction) => {
	let coupons = [];
...
export const handleDeleteCoupon = TryCatch(async (req: Request, res: Response, next: NextFunction) => {
	const {id} = req.params;
