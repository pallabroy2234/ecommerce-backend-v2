...
export const handleGetDashboardStats = TryCatch(async (req: Request, res: Response, next: NextFunction) => {
	let stats = {};
 ...
 * @access          Private/Admin
 */
export const handleGetPieChartsData = TryCatch(async (req: Request, res: Response, next: NextFunction) => {
	let charts = {};
...
export const handleGetBarChartsData = TryCatch(async (req: Request, res: Response, next: NextFunction) => {
	let barCharts = {};
 ...
 * @access          Private/Admin
 */
export const handleGetLineChartsData = TryCatch(async (req: Request, res: Response, next: NextFunction) => {
	let barCharts = {};
