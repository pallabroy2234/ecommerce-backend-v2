...
import { handleDeleteOrder, handleGetAllOrders, handleGetOrderDetails, handleNewOrder, handleProcessOrder, handlerMyOrders, } from "../controllers/orderControllers.js";
import { validateDeleteOrder, validateMyOrders, validateNewOrder, validateOrderDetails, validateProcessOrder, } from "../validators/validateOrder.js";
